...
import 'package:butterfly/ui/validators.dart';
...
class SignUpBloc extends Bloc<SignUpEvent, SignUpState> {
  ...
  SignUpBloc({@required UserRepository userRepository}) : assert(userRepository != null),
  ...
  Stream<SignUpState> _mapPasswordChangedToState (String password) async* {
    yield state.update(isEmailValid: Validators.isValidEmail(password));
  }
